  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-y-auto" id="legal-modal">
        ...
        {/* Modal Outer Wrapper to help centering */}
        <div className="flex min-h-screen items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4 mb-5">
              <div>
                <span className="text-[10px] font-black text-us-blue uppercase tracking-widest bg-blue-50 px-2.5 py-1 rounded-full inline-block mb-2">
                  {content.subtitle}
                </span>
              ...
              <button
                onClick={onClose}
                className="bg-slate-50 hover:bg-slate-100 text-slate-450 hover:text-slate-650 p-1.5 rounded-full transition-colors flex-shrink-0"
                aria-label="Cerrar legal"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            {/* Scrollable Body */}
            <div className="max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar focus:outline-none">
              {content.body}
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-slate-100 flex justify-end">
              <button
                onClick={onClose}
                className="px-5 py-2.5 bg-slate-150 hover:bg-slate-200 text-slate-800 text-xs font-bold rounded-xl transition-all active:scale-95"
              >
                Cerrar documento
              </button>
            </div>
